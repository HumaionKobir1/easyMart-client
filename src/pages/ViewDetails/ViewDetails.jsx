...
import { FaRegStar, FaStar, FaFacebook, FaGoogle, FaTwitter, FaInstagram, FaWifi } from "react-icons/fa";
import Breatcam from "../../shared/Breatcam/Breatcam";
import Rating from "react-rating";
import { useState } from "react";

const ViewDetails = () => {
    const productDetails = useLoaderData();
    const{product,  price_regular, discount, price_discounted, review, details, images} = productDetails;
                ...
                <div className="flex gap-6">
                    <div className="w-[20%]">
                        <div className="border rounded-md p-5">
                            ...
                            <p className="text-gray-600 hover:text-red-500 cursor-pointer text-lg mt-5">Clothing</p>
                            <p className="text-gray-600 hover:text-red-500 cursor-pointer text-lg mt-2">Bags</p>
                            <p className="text-gray-600 hover:text-red-500 cursor-pointer text-lg mt-2">Footewear</p>
                            <p className="text-gray-600 hover:text-red-500 cursor-pointer text-lg mt-2">Watches</p>
                            <p className="text-gray-600 hover:text-red-500 cursor-pointer text-lg mt-2">Accessories</p>
                        </div>
                        <div className="border rounded-md p-5 mt-6">
                            <div className=" flex items-center gap-3">
                                ...
                                <div className="content-right">
                                    <h5 className="text-gray-700 text-xl">Free Shipping</h5>
                                    <p className="text-gray-600">Free Shipping World Wide</p>
                                </div>
                            </div>
                            <div className="border border-t-2 mt-4 text-gray-500 h-1 w-full"></div>
                            <div className=" flex items-center mt-4 gap-3">
                                <div className="w-20">
                                <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 480 480"  xml:space="preserve" width="512px" height="512px">
                                       <g>
                                           <g>
                                              <g>
                                ...
                                <div className="content-right">
                                    <h5 className="text-gray-700 text-xl">24 X 7 Service</h5>
                                    <p className="text-gray-600">Online Service For 24 x 7</p>
                                </div>
                            </div>
                            <div className="border border-t-2 mt-4 text-gray-500 h-1 w-full"></div>
                            <div className=" flex items-center mt-4 gap-3">
                                <div className="w-28">
                                <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 -14 512.00001 512">
                                ...
                                <div className="content-right">
                                    <h5 className="text-gray-700 text-xl">Festival Offer</h5>
                                    <p className="text-gray-600">New Online Special Festival</p>
                                </div>
                            </div>
                            <div className="border border-t-2 mt-4 text-gray-500 h-1 w-full"></div>
                            <div className=" flex items-center gap-3 mt-4">
                                <div className="w-28">
                                <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve" width="512px" height="512px">
                                                 <g>
                                                    <g>
                                                       <g>
                                ...
                                <div className="content-right">
                                    <h5 className="text-gray-700 text-xl">Online Payment</h5>
                                    <p className="text-gray-600">New Online Special Festival</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="w-[40%]">
                        ...
                        <div className="flex mt-5 gap-3 overflow-hidden">
                            <img className="w-[22.5%]" src={images[1]} alt="" />
                            <img className="w-[23%]" src={images[0]} alt="" />
                            <img className="w-[23%]" src={images[1]} alt="" />
                            <img className="w-[23%]" src={images[0]} alt="" />
                        </div>
                    </div>
                    <div className="w-[40%]">
                        <h1 className="text-2xl uppercase font-semibold">{product}</h1>
                        <div className="price flex gap-2 mt-3">
                            <h5 className="text-gray-700 text-lg">{price_regular}$</h5>
                            <h3 className="text-rose-500 text-xl">{discount}% off</h3>
                        </div>
                        <del className="text-3xl remove:border mt-2">{price_discounted}$</del>
                        ...
                        />
                            <p className="text-black ml-1">{review}</p>
                        </div>
                        <div className="border-dashed border-t-2 mt-4 text-gray-500 h-1 w-full"></div>
                        <div className="flex justify-between mt-5">
                            <h4 className="text-xl">Select Size</h4>
                            <h4 className="text-xl">Size Chart</h4>
                        </div>
                        <div className="flex gap-5 mt-5">
                            <div className="border  hover:bg-rose-700 transition hover:text-white border-gray-300 rounded-full p-3">
                                s
                            </div>
                            <div className="border border-gray-300  hover:bg-rose-700 transition hover:text-white rounded-full p-3">
                                m
                            </div>
                            <div className="border border-gray-300  hover:bg-rose-700 transition hover:text-white rounded-full p-3">
                                l
                        ...
                        <h4 className="text-rose-500 text-lg mt-4 font-semibold">InStock</h4>
                        <h4 className=" text-lg mt-1 font-semibold">Quantity</h4>
                        <div className="relative mt-4 w-40">
                            <input
                                ...
                                className="appearance-none block w-full bg-white border border-gray-300 rounded-md py-2 pl-4 pr-10 placeholder-gray-500 focus:outline-none focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                            />
                        </div>
                        <div className="flex gap-5 mt-5">
                            <button className="text-md font-semibold text-white hover:text-black bg-rose-600 hover:bg-white border border-rose-600 transition py-2 px-3 rounded-lg">ADD TO CART</button>
                            <button className="text-md font-semibold text-white hover:text-black bg-rose-600 hover:bg-white border border-rose-600 transition py-2 px-3 rounded-lg">BUY NOW</button>
                        </div>
                        <div className="border-dashed border-t-2 mt-4 text-gray-500 h-1 w-full"></div>
                        <h6 className="font-bold mt-5">Product Details</h6>
                        <p className="text-gray-700 mt-2">{details}</p>
                        <div className="border-dashed border-t-2 mt-4 text-gray-500 h-1 w-full"></div>
                        <h6 className="text-lg font-semibold mt-3">Share It</h6>
